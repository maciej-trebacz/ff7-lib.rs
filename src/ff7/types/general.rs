...
pub struct FF7BasicData {
    ...
    pub field_alt_encounters_enabled: u8,
    ...
    pub exp_multiplier_mode: u8,
    pub gil_multiplier: u8,
    pub gil_multiplier_mode: u8,
    pub ap_multiplier: u8,
    pub ap_multiplier_mode: u8,
    ...
    pub auto_sense_check: u8,
    pub field_run_by_default_check: u8,
} 